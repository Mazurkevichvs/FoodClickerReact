...
<div className="container">
		...
		{/* <!-- END Hidden Required Fields --> */}
                    ...
                    <label className="form__label" for="username">Imię i Nazwisko</label>
                    <input type="text" name="Name" className="form__name" id="username" required/>
                    <label className="form__label" for="email">Adres E-mail</label>
                    <input type="text" name="e-mail" className="form__name" id="email" required/>
                    <label for="comment" className="form__label">Wiadomość</label>
